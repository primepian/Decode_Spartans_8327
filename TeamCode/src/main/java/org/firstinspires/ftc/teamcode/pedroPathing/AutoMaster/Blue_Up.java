...
public class Blue_Up extends OpMode{
    ...
    private final Pose shoot_Pose = new Pose(54, 90.000, Math.toRadians(137.5));           //TL:Path #2 TODO: Shoot fixme:50, 95.000, Math.toRadians(135)
    ...
    public void autonomousPathUpdate() {
        ...
        switch (pathState) {
            case 0: //start to obelisk
                ...
                mecanism.B = 1;
                mecanism.C = 2;
                mecanism.shootPow(.82);//note: power ++++++
                break;
            ...
            case 27:
                if (follower.getPose().getY() > 8){
                    mecanism.shootPow(0.65); //note: Power +++++
                }
                if (!follower.isBusy()) {
    ...
    @Autonomous(group = "Blue")
    public static class Blue_Up2 extends OpMode{
        Mecanismos mecanism = new Mecanismos();
        ...
        private final Pose shoot_Pose = new Pose(62.000, 136.500, Math.toRadians(180));           //TL:Path #2 TODO: Shoot fixme: new Pose(50, 95.000, Math.toRadians(137.5));
