...
public class Blue_Up extends OpMode{
    ...
    private final Pose fst_itk_pose = new Pose(48.000, 81.000, Math.toRadians(180));          //TL:Path #3

    private final Pose fst_itk_1 = new Pose(35.000, 81.000, Math.toRadians(180));             //TL:Path #4

    private final Pose fst_itk_2 = new Pose(30.000, 81.000, Math.toRadians(180));             //TL:Path #5

    private final Pose fst_itk_3 = new Pose(22.000, 81.000, Math.toRadians(180));             //TL:Path #6

    private final Pose shoot_Pose_2 = new Pose(49.000, 96.000, Math.toRadians(127));          //TL:Path #7 TODO: SECOND SHOOT fixme
