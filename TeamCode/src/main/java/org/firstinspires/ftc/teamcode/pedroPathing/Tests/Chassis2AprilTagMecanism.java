...
public class Chassis2AprilTagMecanism {
    final double DESIRED_DISTANCE =  40; //  this is how close the camera should get to the target (inches)
...
//    final double STRAFE_GAIN =  0.015 ;   //  Strafe Speed Control "Gain".  e.g. Ramp up to 37% power at a 25 degree Yaw error.   (0.375 / 25.0)
    ...
    public DcMotor frontRightDrive = null;  //  Used to control the right front drive wheel
    public DcMotor backLeftDrive = null;  //  Used to control the left back drive wheel
    public DcMotor backRightDrive = null;  //  Used to control the right back drive wheel

    public static final boolean USE_WEBCAM = true;  // Set true to use a webcam, or false for a phone camera
    public static final int DESIRED_TAG_ID = 20;     // Choose the tag you want to approach or set to -1 for ANY tag.
    ...
    public double  turn            = 0;        // Desired turning power/speed (-1 to +1)
